...
test('dashboard itinerary cards use subtle expand icons to open an iCal-style day window', () => {
  ...
  assert.match(html, /const visibleEventLimit=2/);
  assert.match(html, /const needsExpand=dayEvents\.length>visibleEventLimit/);
  ...
  assert.match(html, /\.calendar-events\.is-collapsed \.calendar-event:nth-of-type\(n\+3\)/);
