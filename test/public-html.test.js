...
test('people profiles live in an animated fit-content dashboard tab control', () => {
  ...
  assert.match(html, /'Tanner':\{floor:'1st floor', apartment:'1st floor apartment', bed:'Queen', roommates:\['David'\]\}/);
  assert.match(html, /'Andie':\{floor:'3rd floor', apartment:'3rd floor apartment', bed:'Queen', roommates:\['Zach'\]\}/);
  assert.match(html, /'Jacob G\.':\{floor:'3rd floor', apartment:'3rd floor apartment', bed:'Twin', roommates:\['Jacob M\.'\]\}/);
  assert.match(html, /'Amanda':\{floor:'2nd floor', apartment:'2nd floor apartment', bed:'Twin', roommates:\['Kait'\]\}/);
  assert.match(html, /'Candace':\{floor:'2nd floor', apartment:'2nd floor apartment', bed:'Queen', roommates:\['Erika'\]\}/);
